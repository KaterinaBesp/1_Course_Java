...
// В классе MainGameField, который представляет собой игровое поле происходит отрисовка поля, ходов игроков.
// Также реализовано множество методов
...
public class MainGameField extends JPanel {
    ...
    // Получение экземпляра MainGameField (глобальная точка доступа, много вариантов решения (мало что поняла), это вариант 1 для однопоточного приложения кажется)
